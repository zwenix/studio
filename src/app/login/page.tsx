    ...
    <div className="w-full max-w-sm">
      <div className="flex justify-center mb-6">
        <Link href="/" className="flex items-center gap-3 text-white">
            ...
            <h1 className="text-2xl font-bold font-headline">EduAI Companion</h1>
        </Link>
      </div>
        ...
        <CardContent>
          <form onSubmit={handleLogin} className="grid gap-4">
            <div className="grid gap-2">
              ...
              <Input
                ...
                className="bg-transparent border-white/30 placeholder:text-gray-400"
              />
            </div>
            <div className="grid gap-2">
              <div className="flex items-center">
                <Label htmlFor="password">Password</Label>
                <Link href="#" className="ml-auto inline-block text-sm underline hover:text-indigo-300">
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-slate-900 px-2 text-gray-300">
                Or continue with
              </span>
            </div>
          </div>
          <Button variant="outline" className="w-full bg-white/90 text-slate-800 hover:bg-white" onClick={handleGoogleSignIn} disabled={isLoading || isGoogleLoading}>
